...
const Dashboard = ({route}) => {
  ...
  const handlePressPrevious = () => {
    ...
    // if (todayPunchIns[startIndex] && todayPunchIns[startIndex + 1]) {
    //   const firstPunchIn = todayPunchIns[startIndex].punch_in;
    //   const secondPunchIn = todayPunchIns[startIndex + 1].punch_in;

    //   nineToOnePm(firstPunchIn, secondPunchIn);
    //   onePmToFivePm(firstPunchIn, secondPunchIn);
    // }
  };
  ...
  console.log('todayPunchData:-------', todayPunchData);
  ...
  return (
    <View>
                      ...
                      {Array.isArray(employeeData) &&
                        employeeData
                          ...
                          .map((item, index) => {
                            ...
                            if (isToday) {
                              return todayPunchData.length >0 ? (
                                <View
                                  key={index.toString()}
                                  style={{
                                    flexDirection: 'row',
      ...
      <View
        style={{position: 'absolute', bottom: '5%', right: '50%', zIndex: 1}}>
        <TouchableOpacity
          onPress={() => {
            handlePunch();
          }}
